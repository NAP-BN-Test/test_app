...
const InfoAdminUser = () => {
              ...
              <View style={{ flex: 1, flexDirection: 'row' }}>
                ...
                <View style={{ flex: 1, marginLeft: SIZES.radius }}>
                    <Button icon="account-check-outline" color="tomato" style={{ paddingLeft: "1%"}}>
                        <Text style={styles.textColor}>Tùng Nhật</Text>
                    </Button>
                    <Button icon="email-multiple-outline" color="tomato">
                        <Text style={styles.textColor}>tung24041998@gmail.com</Text>
                    </Button>
  ...
  const _handleTC = () => console.log('Xóa');
  return (
    <ScrollView>
